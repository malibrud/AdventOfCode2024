...
int8_t getGateValue( Device *d, Gate *g, int depth ) {
    ...
    int8_t v1 = getGateValue( d, gin1, depth + 1 );
    int8_t v2 = getGateValue( d, gin2, depth + 1 );
...
int main( int argc, char **argv ) {
    ...
    {
        int64_t bit = (int64_t)getGateValue( &d, &d.gates[ i ], 0 );
        val |= bit << shift++;
    }
